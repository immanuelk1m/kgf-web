      ...
      <div className="flex w-full min-h-screen">
        ...
        <div className="w-full max-w-[1280px] min-h-screen flex flex-col">
          ...
          <div className="flex flex-col md:flex-row w-full p-4">
            <div className="w-full md:w-4/5 border-2 border-gray-200 p-6 bg-gray-50 rounded-lg shadow transition hover:shadow-lg">
              <Kospiema />
            </div>
          ...
          <div className="flex flex-col md:flex-row w-full p-4">
            ...
            <div className="w-full md:w-1/5 p-4">
              <div className="border-2 border-gray-200 p-4 bg-white rounded-lg shadow text-sm">
                ...
                <h2 className="text-lg font-semibold text-gray-800">VIX와 VIX 50일 이동평균선</h2>
                <p className="mt-2 text-gray-600">
          ...
          <div className="flex flex-col md:flex-row w-full p-4">
            ...
            <div className="w-full md:w-1/5 p-4">
              <div className="border-2 border-gray-200 p-4 bg-white rounded-lg shadow text-sm">
                ...
                <h2 className="text-lg font-semibold text-gray-800">5일 이동평균선</h2>
                <p className="mt-2 text-gray-600">
          ...
          <div className="flex flex-col md:flex-row w-full p-4">
            ...
            <div className="w-full md:w-1/5 p-4">
              <div className="border-2 border-gray-200 p-4 bg-white rounded-lg shadow text-sm">
                ...
                <h2 className="text-lg font-semibold text-gray-800">채권 수익률과 주식 수익률의 차이</h2>
                <p className="mt-2 text-gray-600">
